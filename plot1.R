...
#========================================================================================
# plot1.R - uses Electric Power Consumption data from:
# https://archive.ics.uci.edu/ml/datasets/Individual+household+electric+power+consumption
# builds a reduced sized dataset (1st and 2nd of Feb 2007 only)
#
# and plots a histogram showing frequency of Global Active Power
# 
#========================================================================================
...
#Open PNG device, add histogram and close
